      ...
      <main className="mx-auto flex w-full max-w-2xl flex-col px-6 py-20 lg:px-8">
        ...
        >
          ...
          <div>
            <label
              htmlFor="username"
              className="mb-2 block text-sm font-medium text-purple-100"
            >
              Username
            </label>
            <div
              className={`flex items-center rounded-lg border bg-slate-900/60 px-3 py-2 ${errors.username ? "border-red-400" : "border-white/20"}`}
            >
            ...
            <div className="flex gap-3">
              ...
              <div className="relative w-36" ref={dropdownRef}>
                ...
                >
                  ...
                  <svg
                    className="ml-auto h-4 w-4 text-purple-200"
                    viewBox="0 0 20 20"
                    fill="none"
                  >
                    <path
          ...
          <div>
            ...
            <div
              className={`flex items-center rounded-lg border bg-slate-900/60 px-3 ${errors.password ? "border-red-400" : "border-white/20 focus-within:border-purple-400"}`}
            >
              <input
                id="password"
