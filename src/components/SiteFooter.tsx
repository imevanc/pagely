...
export const SiteFooter = () => (
  <footer className="border-t border-white/10 bg-purple-950/95">
    <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-10 lg:grid-cols-2 lg:px-8">
      <div>
        ...
        <p className="mt-4 max-w-md text-sm text-purple-100">
          Build a premium creator presence with one beautiful page and zero
          technical friction.
        </p>
      ...
      <div className="grid grid-cols-2 gap-3">
        {footerLinks.map((link) => (
          <a
            key={link.label}
            href={link.href}
            className="text-sm text-purple-100 transition hover:text-white"
          >
            {link.label}
          </a>
        ))}
